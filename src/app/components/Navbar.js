...
export default function Navbar() {
  ...
  // Scroll state handling (adds shadow + border when you scroll)
  useEffect(() => {
    ...
    <header className={headerClasses}>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
          ...
          {menuItems.map(({ label, href }) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={[
                    "absolute -bottom-1 left-0 h-[2px] w-full rounded-full bg-gradient-to-r from-teal-400 via-cyan-300 to-indigo-400 transition-transform origin-left",
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/contact"
            className="ml-2 px-4 py-2.5 text-sm rounded-md font-medium bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-md hover:scale-105 transition-transform"
          >
            Get a Quote
          </Link>
        </div>
